...
@implementation PlugInSUStandardVersionComparator

+ (PlugInSUStandardVersionComparator *)defaultComparator
{
	static PlugInSUStandardVersionComparator *defaultComparator = nil;
	if (defaultComparator == nil)
		defaultComparator = [[PlugInSUStandardVersionComparator alloc] init];
